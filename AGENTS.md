...
- **Pages:** A deck is an ordered list of pages. Each page has its own HTML content plus per-page metadata (font scale, margin scale, dark mode, custom CSS); font family is deck-level.
